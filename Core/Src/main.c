...
GPIO_InitTypeDef GPIO_InitStructPrivate = {0};
  ...
  uint16_t * currentpossition;
//  uint16_t currentpossition_x = 30;
//  uint16_t currentpossition_y = 120;
#define _CURRENTPOSX 30
#define _CURRENTPOSY 120
/* USER CODE END PV */
